                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <router-link :to="'/payOrder/'+this.$route.params.id" class="Apay" v-if="orderinfo.status==1" >去付款</router-link>
                                                    <a class="Amypay" v-if="orderinfo.status<4&&orderinfo.status>1" @click="signExpress">已签收</a> 
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
                                                <dt>订单状态：</dt>
                                                    ...
                                                    <tr>
                                                        <td colspan="7" align="right">
                                                            ...
                                                            <p style="font-size: 22px;">应付总金额：
                                                                <b class="red" style="color:red">￥{{ orderinfo.order_amount }}</b>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
